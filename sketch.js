...
function setup() {
    ...
    ball2 = Bodies.circle(375,200,10,ball_options);
    World.add(world,ball2);

	ball3 = Bodies.circle(400,200,10,ball_options);
	World.add(world,ball3);

	ball4 = Bodies.circle(425,200,10,ball_options);
	World.add(world,ball4);

	ball5 = Bodies.circle(450,200,10,ball_options);
...
function draw() {
  ...
  rect(roof.position.x,roof.position.y,175,20);
...
function keyPressed()
{
  if(keyCode==RIGHT_ARROW)
    {
      Matter.Body.applyForce(ball5,{x:0,y:0},{x:0.005,y:0});
    }
